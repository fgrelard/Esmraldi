...
.. image:: ../_images/maldi_cube.png
   :width: 30%
   :alt: Example of a MALDI datacube
   :align: left
On one hand, Matrix Assisted Laser Desorption Ionization – Imaging
Mass Spectrometry (MALDI–IMS) is an acquisition technique which
...
.. image:: ../_images/mri.png
   ...
   :alt: Example of a MALDI datacube
   :align: right
On the other hand, Magnetic Imaging Resonance (MRI) images
highlight the structural organization of a tissue. The intensity in the images
...
From an image analyst standpoint, this means finding the ion images in MALDI-IMS whose intensity distribution correlate with the intensity distribution in MRI images.
...
1. Image pre-processing: reduction of MALDI images, spectra processing
...
4. Statistical analysis: correlation between MRI and MALDI images
