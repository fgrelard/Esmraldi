...
parser.add_argument("--resolution_fixed", help="Resolution for fixed image", default=1)
parser.add_argument("--resolution_moving", help="Resolution for moving image", default=1)
parser.add_argument("--spacing_fixed", nargs="+", type=int, help="Spacing on the z-axis for fixed image", default=[1])
parser.add_argument("--spacing_moving", nargs="+", type=int, help="Spacing on the z-axis for moving image", default=[1])
